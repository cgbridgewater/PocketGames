...
import StackableIcon from "../assets/images/StackableIcon.png";
    ...
    return (
        <main>
            ...
            <div className="game_icon_container">
                ...
                <GameCard to="/games/stackable" text="Stackable" image={StackableIcon} isComplete={false} />
                ...
                {/* <GameCard to="/#" text="Placeholder" image={PlaceHolder} isComplete={false} /> */}
            </div>
        </main>
    );
}
